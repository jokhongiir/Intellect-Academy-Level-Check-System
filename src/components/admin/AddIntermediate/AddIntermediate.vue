...
import './AddIntermediate.css'

const LEVEL = 'intermediate'
const TABLE_NAME = 'intermediate_tests'
  ...
  <div class="tests-page">
    ...
    <div class="page-header">
      <div class="header-left">
        <h2>Intermediate — Tests & Questions</h2>
        <p>Intermediate darajasi uchun test va savollarni boshqaring</p>
      </div>
          ...
          <template v-else>
            <div class="info-badges">
              <div>
                ...
                <span class="level-badge intermediate">{{ selectedTest.level }}</span>
              </div>
              <div>
    ...
    >
      <div class="modal-card create-modal">
        <div class="modal-header">
          <h3>Add New Question — Intermediate</h3>
